...
![1.png](./第14章 MySQL事务日志.assets/1.png)
...
![2.png](./第14章 MySQL事务日志.assets/2.png)
...
![3.png](./第14章 MySQL事务日志.assets/3.png)
...
![5.png](./第14章 MySQL事务日志.assets/5.png)

##### **1.4 redo的整体流程**

![4.png](./第14章 MySQL事务日志.assets/4.png)
...
![6.png](./第14章 MySQL事务日志.assets/6.png)
...
![7.png](./第14章 MySQL事务日志.assets/7.png)

##### **1.6** **不同刷盘策略演示**

**1.** **流程图**

![12.png](./第14章 MySQL事务日志.assets/12.png)

![8.png](./第14章 MySQL事务日志.assets/8.png)

![9.png](./第14章 MySQL事务日志.assets/9.png)

![10.png](./第14章 MySQL事务日志.assets/10.png)

![11.png](./第14章 MySQL事务日志.assets/11.png)
...
![13.png](./第14章 MySQL事务日志.assets/13.png)

**2. redo** **日志写入log buffer**

不同的事务可能是`并发`执行的，所以`事务T1`、`事务T2`之间的`mtr`可能是`交替执行`的。

![14.png](./第14章 MySQL事务日志.assets/14.png)

![15.png](./第14章 MySQL事务日志.assets/15.png)

![17.png](./第14章 MySQL事务日志.assets/17.png)
...
![18.png](./第14章 MySQL事务日志.assets/18.png)

**3. checkpoint**

<img src="./第14章 MySQL事务日志.assets/19.png" alt="19.png" style="zoom:67%;" />

![20.png](./第14章 MySQL事务日志.assets/20.png)

如果 write pos 追上 checkpoint ，表示**日志文件组**满了，这时候不能再写入新的 redo log记录，MySQL 得停下来，清空一些记录，把 checkpoint 推进一下。

![21.png](./第14章 MySQL事务日志.assets/21.png)
...
![22.png](./第14章 MySQL事务日志.assets/22.png)

##### **2.2 Undo日志的作用**

- **作用1：回滚数据**

![23.png](./第14章 MySQL事务日志.assets/23.png)
...
![24.png](./第14章 MySQL事务日志.assets/24.png)

![25.png](./第14章 MySQL事务日志.assets/25.png)

![26.png](./第14章 MySQL事务日志.assets/26.png)
...
![27.png](./第14章 MySQL事务日志.assets/27.png)

##### **2.4 undo的类型** 

在`InnoDB`存储引擎中，undo log分为：

![28.png](./第14章 MySQL事务日志.assets/28.png)

##### **2.5 undo log的生命周期**

![29.png](./第14章 MySQL事务日志.assets/29.png)

**1.** **简要生成过程**

**只有Buffer Pool的流程：**

![30.png](./第14章 MySQL事务日志.assets/30.png)

**有了Redo Log和Undo Log之后：**

![31.png](./第14章 MySQL事务日志.assets/31.png)

**2.** **详细生成过程**

![32.png](./第14章 MySQL事务日志.assets/32.png)
...
![33.png](./第14章 MySQL事务日志.assets/33.png)

**当我们执行UPDATE时：**

![34.png](./第14章 MySQL事务日志.assets/34.png)

```mysql
UPDATE user SET id=2 WHERE id=1;
```

![35.png](./第14章 MySQL事务日志.assets/35.png)
