...
![1记录.png](./第07章 InnoDB数据存储结构.assets/1记录.png)
...
<img src="./第07章 InnoDB数据存储结构.assets/2页的上层结构.png" alt="2页的上层结构.png" style="zoom:67%;" />
...
![3页.png](./第07章 InnoDB数据存储结构.assets/3页.png)
...
![4页与页、.png](./第07章 InnoDB数据存储结构.assets/4页与页、.png)
...
<img src="./第07章 InnoDB数据存储结构.assets/5空闲空间.png" alt="5空闲空间.png" style="zoom:67%;" />
...
![8最小记录最大记录.png](./第07章 InnoDB数据存储结构.assets/8最小记录最大记录.png)

这两条记录`不是我们自己定义的记录`，所以它们并不存放在页的`User Records`部分，他们被单独放在一个称为`Infimum + Supremum`的部分

<img src="./第07章 InnoDB数据存储结构.assets/9最小记录最大记录.png" alt="9最小记录最大记录.png" style="zoom: 80%;" />
...
<img src="./第07章 InnoDB数据存储结构.assets/10newxt record.png" alt="10newxt record.png" style="zoom:80%;" />
...
<img src="./第07章 InnoDB数据存储结构.assets/11删除.png" alt="11删除.png" style="zoom:80%;" />

下图是再增加回来的图片

<img src="./第07章 InnoDB数据存储结构.assets/12增加.png" alt="12增加.png" style="zoom:80%;" />
...
<img src="./第07章 InnoDB数据存储结构.assets/6行格式.png" alt="6行格式.png" style="zoom: 80%;" />
...
![7记录头信息.png](./第07章 InnoDB数据存储结构.assets/7记录头信息.png)
...
![13数据字典.png](./第07章 InnoDB数据存储结构.assets/13数据字典.png)
