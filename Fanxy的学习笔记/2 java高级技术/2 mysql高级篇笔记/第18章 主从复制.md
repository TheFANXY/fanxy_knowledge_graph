...
![2.png](./第18章 主从复制.assets/2.png)

  ![3.png](./第18章 主从复制.assets/3.png)
...
在网络正常的时候，日志从主库传给从库所需的时间是很短的，即T2-T1的值是非常小的。即，网络正常情况下，主备延迟的主要来源是备库接收完`binlog和执行完这个事务之间的时间差。
...
![19.png](./第18章 主从复制.assets/19.png)

**方法** **1：异步复制**

这个commit是redo log的commit标志，详细参考之前日志的`binlog`和`redolog`日志的部分

![20.png](./第18章 主从复制.assets/20.png)

**方法** **2：半同步复制**

![24.png](./第18章 主从复制.assets/24.png)

![21.png](./第18章 主从复制.assets/21.png)

**方法** **3：组复制**

![22.png](./第18章 主从复制.assets/22.png)

![23.png](./第18章 主从复制.assets/23.png)

#### 4. 一主一从架构配置

![6.png](./第18章 主从复制.assets/6.png)

![7.png](./第18章 主从复制.assets/7.png)
...
![8.png](./第18章 主从复制.assets/8.png)

![9.png](./第18章 主从复制.assets/9.png)
...
![10.png](./第18章 主从复制.assets/10.png)

```sql
show master status;
```

![11.png](./第18章 主从复制.assets/11.png)
...
![12.png](./第18章 主从复制.assets/12.png)

![14.png](./第18章 主从复制.assets/14.png)

![15.png](./第18章 主从复制.assets/15.png)

![16.png](./第18章 主从复制.assets/16.png)
...
![17.png](./第18章 主从复制.assets/17.png)

##### **4.8** **后续**

**搭建主从复制：双主双从**

![18.png](./第18章 主从复制.assets/18.png)
