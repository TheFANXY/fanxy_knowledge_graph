...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/1.png" alt="1" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/2.png" alt="2.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/3.png" alt="3.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/4.png" alt="4.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/5.png" alt="5.png" style="zoom: 80%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/6.png" alt="6.png" style="zoom:80%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/7.png" alt="7.png" style="zoom:67%;" />


- **help @数据类型：查看redis数据类型的使用说明**

<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/8.png" alt="8.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/9.png" alt="9.png" style="zoom:67%;" />
...
![10.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/10.png)
...
![11.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/11.png)
...
![12.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/12.png)
...
![13.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/13.png)
...
![14.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/14.png)
...
![15.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/15.png)
...
![16.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/16.png)
利用这个机制可以自己定义一个分布式锁，因为我们在java中的sync / lock / unlock 的操作，本质只能在同一个jvm之中才能做到，分布式可以利用redis来完成类似锁的操作。
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/17.png" alt="17.png" style="zoom:67%;" />
...
![18.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/18.png)
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/19.png" alt="19.png" style="zoom:67%;" />

**`getrange key start end`**：获取key值指定范围的内容，start表示开始索引，end表示结束索引。0到-1表示获取全部。

![20.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/20.png)
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/24.png" alt="24.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/22.png" alt="22.png" style="zoom:67%;" />
...
![25.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/25.png)
...
![26.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/26.png)
...
## 二. List
![27.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/27.png)
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/28.png" alt="28.png" style="zoom: 80%;" />

![29.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/29.png)
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/30.png" alt="30.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/31.png" alt="31.png" style="zoom:67%;" />
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/32.png" alt="32.png" style="zoom:67%;" />
...
![33.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/33.png)

![34.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/34.png)
...
![35.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/35.png)
...
![36.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/36.png)
...
![37.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/37.png)
...
![38.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/38.png)
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/39.png" alt="39.png" style="zoom:67%;" />
...
![40.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/40.png)
...
![41.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/41.png)

### 13. 应用场景
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/42.png" alt="42.png" style="zoom:67%;" />
...
![43.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/43.png)


Hash结构可以将对象中的每个字段独立存储，可以针对单个字段做CRUD，下面是两个哈希表：

![44.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/44.png)
...
![45.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/45.png)


**`HGET key field `**：根据给定域field返回对应的value值。当key不存在或者field不存在，返回nil。

![46.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/46.png)
...
![47.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/47.png)
...
![48.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/48.png)
...
![49.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/49.png)
...
![50.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/50.png)
...
![51.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/51.png)
...
![52.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/52.png)
...
![53.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/53.png)
...
![54.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/54.png)
...
![55.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/55.png)


![56.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/56.png)
...
![57.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/57.png)
...
![58.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/58.png)
...
![59.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/59.png)
...
![60.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/60.png)
...
![61.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/61.png)
...
![62.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/62.png)
...
![63.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/63.png)
...
![64.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/64.png)
...
![65.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/65.png)


### 10. 应用场景
1. 微信抽奖小程序
![66.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/66.png)

2. 查看微信点赞共同好友
![67.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/67.png)

3. QQ内推可能认识的人
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/68.png" alt="68.png" style="zoom:67%;" />
...
![69.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/69.png)
...
![70.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/70.png)
...
![71.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/71.png)
...
![72.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/72.png)
...
![73.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/73.png)
...
![74.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/74.png)
...
![75.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/75.png)

**`ZREVRANK key member`**：返回有序集 `key` 中指定成员 `member` 的排名。*从大到小*

![76.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/76.png)
...
![77.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/77.png)
...
![78.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/78.png)
...
![79.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/79.png)
...
![80.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/80.png)
...
![81.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/81.png)
...
<img src="./2. Redis7【② Key通用命令 十大数据类型】.assets/82.png" alt="82.png" style="zoom:67%;" />

2. 按照年
**这里应该是440MB**
![83.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/83.png)
...
![84.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/84.png)
...
redis5 之前实现消息队列痛点
可以使用list来实现点对点的模式
![85.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/85.png)
pub / sub 实现多对多
![86.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/86.png)
...
![87.png](./2. Redis7【② Key通用命令 十大数据类型】.assets/87.png)
