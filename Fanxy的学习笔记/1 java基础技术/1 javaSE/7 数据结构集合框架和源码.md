...
![1](./7 数据结构集合框架和源码.assets/集合源码1.png)
...
![2.png](./7 数据结构集合框架和源码.assets/集合源码2.png)
...
- 缺点：需要额外的空间来表达数据之间的逻辑关系，不支持下标访问和随机访问
 ...
 ![img](./7 数据结构集合框架和源码.assets/集合源码3.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码4.png)
...
- 缺点：不支持排序，一般比用线性表存储需要更多的空间，并且记录的关键字不能重复。
 ...
 ![img](./7 数据结构集合框架和源码.assets/集合源码5.png)
...
![集合源码6.png](./7 数据结构集合框架和源码.assets/集合源码6.png)
...
| 索引                   | [0]     | [1]     | [2]     | [3]     | [4]     |
| ---------------------- | ------- | ------- | ------- | ------- | ------- |
| 值(地址)               | 0xaf4g  | 0xadag  | 0xgaf4  | 0xaafg  | 0xafgf  |
| 实际对象【堆中的对象】 | person1 | person2 | person3 | person4 | person5 |
...
- 具体的，如下图：
 ...
 ![img](./7 数据结构集合框架和源码.assets/集合源码7.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码8.png)

 ![集合源码9.png](./7 数据结构集合框架和源码.assets/集合源码9.png)

## 3.2 自定义链表

### 3.2.1 自定义单向链表

![img](./7 数据结构集合框架和源码.assets/集合源码10.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码11.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码12.png)

 ![img](./7 数据结构集合框架和源码.assets/集合源码13.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码14.png)

![img](./7 数据结构集合框架和源码.assets/集合源码15.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码16.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码17.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码18.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码19.png) 

 **1. `满二叉树`**： 除最后一层无任何子节点外，每一层上的所有结点都有两个子结点的二叉树。 第n层的结点数是2的n-1次方，总的结点个数是2的n次方-1

<img src="./7 数据结构集合框架和源码.assets/集合源码20.png" alt="集合源码20.png" style="zoom:50%;" /> 

 **2. `完全二叉树`：** 叶结点只能出现在最底层的两层，且最底层叶结点均处于次底层叶结点的左侧。

![img](./7 数据结构集合框架和源码.assets/集合源码21.png) 
...
![](./7 数据结构集合框架和源码.assets/集合源码22.png)

**对二叉查找树进行中序遍历，得到有序集合，用于检索。**
...
> 平衡二叉树的目的是为了减少二叉查找树的层次，提高查找速度。平衡二叉树的常用实现有`红黑树`、`AVL`、`替罪羊树`、`Treap`、`伸展树`等。

 <img src="./7 数据结构集合框架和源码.assets/集合源码23.png" style="zoom:50%;" />
...
<img src="./7 数据结构集合框架和源码.assets/集合源码24.png" alt="img" style="zoom:67%;" />
...
- 集合中可以有`重复`的元素，通过元素的equals方法，来比较是否为重复的元素。
 ...
 ![img](./7 数据结构集合框架和源码.assets/集合源码25.png)
...
![集合源码26.png](./7 数据结构集合框架和源码.assets/集合源码26.png)



- **`ArrayList`自动扩容过程**

 ![img](./7 数据结构集合框架和源码.assets/集合源码27.png)



- **`ArrayList`的`add(E e)`方法**

![img](./7 数据结构集合框架和源码.assets/集合源码28.png)



- **`ArrayList`的`add(int index,E e)`方法**

![img](./7 数据结构集合框架和源码.assets/集合源码29.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码30.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码31.png)

 **包含4个元素的LinkedList**

![img](./7 数据结构集合框架和源码.assets/集合源码32.png)

 **add(E e)方法**

![img](./7 数据结构集合框架和源码.assets/集合源码33.png)

 **add(int index,E e)方法**

![img](./7 数据结构集合框架和源码.assets/集合源码34.png)

**remove(Object obj)方法**

![img](./7 数据结构集合框架和源码.assets/集合源码35.png)

**remove(int index)方法**

![img](./7 数据结构集合框架和源码.assets/集合源码36.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码38.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码39.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码40.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码41.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码42.png)
...
## 10.2 Entry中的hash属性为什么不直接使用`key`的`hashCode()`返回值呢？

不管是JDK1.7还是JDK1.8中，都不是直接用key的`hashCode`值直接与`table.length-1`计算求下标的，而是先对`key`的``hashCode`值进行了一个运算，JDK1.7和JDK1.8关于hash()的实现代码不一样，但是不管怎么样都是为了提高hash code值与 (`table.length - 1`)的按位与完的结果，尽量的均匀分布。

![img](./7 数据结构集合框架和源码.assets/集合源码43.png)
...
## 10.3 `HashMap`是如何决定某个key-value存在哪个桶的呢？
...
![img](./7 数据结构集合框架和源码.assets/集合源码44.png)
...
![img](./7 数据结构集合框架和源码.assets/集合源码45.png)

 JDK1.8之后使用：数组+链表/红黑树的结构。

![img](./7 数据结构集合框架和源码.assets/集合源码46.png)
...
## 10.10 JDK1.7中HashMap的循环链表是怎么回事？如何解决？

![img](./7 数据结构集合框架和源码.assets/集合源码47.png)
...
### 3. 在`ArrayList`中remove后面几个元素该怎么做?（惠*、中*亿达）
...
### 2. `HashMap`初始值16，临界值12是怎么算的（软**力）

> 16从底层源码的构造器中看到的。
>
> 12：threshold，使用数组的长度*加载因子(loadFactor)

### 3. `HashMap`长度为什么是2的幂次方(国*时代)

> 为了方便计算要添加的元素的底层的索引i。

### 4. `HashMap`怎么计算哈希值和索引？扩容机制？怎么解决hash冲突？（*软国际、中软*腾）
...
### 8. 在 JDK1.8中，`HashMap`的数据结构与1.7相比有什么变化，这些变化的好处在哪里？（海*科）
...
### 9. `HashMap`的get()方法的原理?（顺*）

> 参考put()

## 11.4 `hashCode`和`equals`

### 1. `hashcode`和equals区别？（海*供应链管理）

> 略

### 2. `hashCode`() 与 equals() 生成算法、方法怎么重写？（阿*校招）

> 进行equals()判断使用的属性，通常也都会参与到`hashCode`()的计算中。
>
> 尽量保证`hashCode`()的一致性。（使用IDEA自动生成，`hashCode`()自动使用相关的算法。
