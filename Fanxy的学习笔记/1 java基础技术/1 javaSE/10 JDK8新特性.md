...
![img](https://img-blog.csdnimg.cn/e74ead631aec434d9ffe54cfee9334f1.png)
...
这两个JDK最大不同就是许可证不一样。**但是对于个人用户来讲，没区别。**  ![img](https://img-blog.csdnimg.cn/b074d217e79342ea834dea22b3f05c06.png)
...
![img](https://img-blog.csdnimg.cn/291bb7bf94804c5f9e0069a3df482bfc.png)
...
![img](https://img-blog.csdnimg.cn/d461613d5d6a44d081a91672d1a05cd0.png)



### 1.4 各版本介绍

![img](https://img-blog.csdnimg.cn/41f02134aea4486dacd5c4812ecda781.png)
...
[JDK 9![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk9/](https://openjdk.java.net/projects/jdk9/) **jdk 10**

[JDK 10![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/10/](https://openjdk.java.net/projects/jdk/10/)
...
[JDK 11![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/11/](https://openjdk.java.net/projects/jdk/11/)
...
>
> 318: [Epsilon: A No-Op Garbage Collector](https://openjdk.java.net/jeps/318) Epsilon — 一个No-Op（无操作）的垃圾收集器 320: [Remove the Java EE and CORBA Modules](https://openjdk.java.net/jeps/320) 删除 Java EE 和 CORBA 模块
>
...
>
> 329: [ChaCha20 and Poly1305 Cryptographic Algorithms](https://openjdk.java.net/jeps/329) ChaCha20 和 Poly1305 加密算法 330: [Launch Single-File Source-Code Programs](https://openjdk.java.net/jeps/330) 启动单一文件的源代码程序
>
...
[JDK 12![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/12/](https://openjdk.java.net/projects/jdk/12/)

> 189：[Shenandoah: A Low-Pause-Time Garbage Collector (Experimental)](https://openjdk.java.net/jeps/189) 低暂停时间的GC 230: [Microbenchmark Suite](https://openjdk.java.net/jeps/230) 微基准测试套件
>
...
[JDK 13![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/13/](https://openjdk.java.net/projects/jdk/13/)
...
[JDK 14![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/14/](https://openjdk.java.net/projects/jdk/14/)
...
>
> 359: [Records (Preview)](https://openjdk.java.net/jeps/359) 361: [Switch Expressions (Standard)](https://openjdk.java.net/jeps/361) Switch表达式
>
...
>
> 364: [ZGC on macOS](https://openjdk.java.net/jeps/364) 365: [ZGC on Windows](https://openjdk.java.net/jeps/365)
>
...
[JDK 15![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/15/](https://openjdk.java.net/projects/jdk/15/)
...
>
> 373: [Reimplement the Legacy DatagramSocket API](https://openjdk.java.net/jeps/373) 重新实现 Legacy DatagramSocket API 374: [Disable and Deprecate Biased Locking](https://openjdk.java.net/jeps/374) 禁用偏向锁定
>
> 375: [Pattern Matching for instanceof (Second Preview)](https://openjdk.java.net/jeps/375) instanceof 模式匹配（第二次预览） 377: [ZGC: A Scalable Low-Latency Garbage Collector](https://openjdk.java.net/jeps/377) ZGC：一个可扩展的低延迟垃圾收集器
>
...
[JDK 16![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/16/](https://openjdk.java.net/projects/jdk/16/)
...
[JDK 17![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://openjdk.java.net/projects/jdk/17/](https://openjdk.java.net/projects/jdk/17/)
...
## 1.5 JDK各版本下载链接
 ...
 [Java Archive | Oracle![img](https://csdnimg.cn/release/blog_editor_html/release2.3.6/ckeditor/plugins/CsdnLink/icons/icon-default.png?t=N7T8)https://www.oracle.com/java/technologies/downloads/archive/](https://www.oracle.com/java/technologies/downloads/archive/)

 ![img](https://img-blog.csdnimg.cn/c275f00fc2434d3f9de36a42f723f3c1.png)
...
![img](https://img-blog.csdnimg.cn/900669bdc6f4443c9c918d335fb87846.png)
...
![img](https://img-blog.csdnimg.cn/f15053b070b94473adec8df7ba83f51f.png)
...
- ![img](https://img-blog.csdnimg.cn/e6107b244dc64acd968309f93235b00e.png)

- 从匿名类到 Lambda 的转换举例2

- ![img](https://img-blog.csdnimg.cn/b4abee7a6e4d4ea5882fae716842e126.png)
...
- **左侧：指定了 Lambda 表达式需要的参数列表，参数的类型都可以省略（参数类型推断），如果形参只有一个，则一对（）也可以省略**
- **右侧：指定了 Lambda 体，是抽象方法的实现逻辑，也即 Lambda 表达式要执行的功能。如果方法体中只有一行语句，可以省略一对{}，如果有return关键字则可以一并省略**
...
![img](https://img-blog.csdnimg.cn/cc83a94d0abc43d7a5ce59a992e5ae0e.png)
...
![img](https://img-blog.csdnimg.cn/0740b1ec7db946e9a0fc47329676965d.png)
...
![img](https://img-blog.csdnimg.cn/3aab6afce19845bbaa04e8c8cac46e5a.png)

举例2：

![img](https://img-blog.csdnimg.cn/558bf37a4c3347f6b199a5146bd7fb5e.png)

 作为参数传递 Lambda 表达式：

![img](https://img-blog.csdnimg.cn/06fea853628449cd9f1b68763c0a498b.png)
...
![img](https://img-blog.csdnimg.cn/9094d193ffb3400dae53d48589ff095e.png)
...
![img](https://img-blog.csdnimg.cn/7f2c5919d61644c09bab8caa986273fe.png)

**类型2：供给型接口**

这类接口的抽象方法特点：无参，但是有返回值

![img](https://img-blog.csdnimg.cn/393dde19d3c94b4baaadad0f49c5737e.png)

**类型3：函数型接口**

这类接口的抽象方法特点：既有参数又有返回值

![img](https://img-blog.csdnimg.cn/2cab4a1c12fd4e98ba3b1c7c9d3c9a84.png)

**类型4：判断型接口**

这类接口的抽象方法特点：有参，但是返回值类型是boolean结果。

![img](https://img-blog.csdnimg.cn/f1cfb580d41d49ccabdab0fa8613feb6.png)
...
**要求1：Lambda体只有一句语句**，并且是通过调用**一个对象的/类现有的方法来完成的**
...
![img](https://img-blog.csdnimg.cn/4743de5af9bb4005b43521a42afd0f24.png)
...
![img](https://img-blog.csdnimg.cn/e8b21b675c9b4d1db69dd0bb557655d2.png)

**2 - 映射**

![img](https://img-blog.csdnimg.cn/5b150ebcde664ac0a7aa3268aace3759.png)**3 - 排序** 

![img](https://img-blog.csdnimg.cn/6976a12f21ef4d099a60d94102c69839.png)**代码举例：**
...
![img](https://img-blog.csdnimg.cn/15c83ed3699d4a65924985cf6b5fc3b4.png)

**2 - 归约**

![img](https://img-blog.csdnimg.cn/30c74ed03fdd4c49b059851d4bed783d.png)**3 - 收集**

![img](https://img-blog.csdnimg.cn/55d2afbf1ea74f438a8614ecd9d90911.png)
