...
![在这里插入图片描述](./0. RabbitMq基础理论.assets/33.png)
### 5.4.2. Fanout 实战
...
![50.png](./0. RabbitMq基础理论.assets/50.png)
...
![51.png](./0. RabbitMq基础理论.assets/51.png)
![52.png](./0. RabbitMq基础理论.assets/52.png)

### 7.7.2. 代码架构图 
在这里新增了一个队列 `delayed.queue`,一个自定义交换机 `delayed.exchange`，绑定关系如下:
![53.png](./0. RabbitMq基础理论.assets/53.png)
![54](./0. RabbitMq基础理论全篇.assets/54.png)
...
![在这里插入图片描述](./0. RabbitMq基础理论.assets/55.png)
### 8.1.2. 代码架构图
![56.png](./0. RabbitMq基础理论.assets/56.png)
### 8.1.3. 配置文件
在配置文件当中需要添加
...
![image-20230711231725814](./0. RabbitMq基础理论.assets/image-20230711231725814.png)
...
![image-20230711235230385](./0. RabbitMq基础理论.assets/image-20230711235230385.png)
...
![image-20230712003214398](./0. RabbitMq基础理论.assets/image-20230712003214398.png)
...
![image-20230712005821026](./0. RabbitMq基础理论.assets/image-20230712005821026.png)
...
![image-20230712011715000](./0. RabbitMq基础理论.assets/image-20230712011715000.png)
...
![image-20230712020711532](./0. RabbitMq基础理论.assets/image-20230712020711532.png)

重启后果然，和我们设想的消费顺序一致

![image-20230712021206112](./0. RabbitMq基础理论.assets/image-20230712021206112.png)
...
![image-20230712021540731](./0. RabbitMq基础理论.assets/image-20230712021540731.png)
...
![image-20230712202242721](./0. RabbitMq基础理论.assets/image-20230712202242721.png)

3. 在 node1 上创建一个队列发送一条消息，队列存在镜像队列

![image-20230712202256950](./0. RabbitMq基础理论.assets/image-20230712202256950.png)
...
![image-20230712202333993](./0. RabbitMq基础理论.assets/image-20230712202333993.png)
...
<img src="./0. RabbitMq基础理论.assets/image-20230712023335339.png" alt="image-20230712023335339" style="zoom:67%;" />
...
![image-20230712205023724](./0. RabbitMq基础理论.assets/image-20230712205023724.png)
...
![image-20230712023625470](./0. RabbitMq基础理论.assets/image-20230712023625470.png)
...
![image-20230712205657823](./0. RabbitMq基础理论.assets/image-20230712205657823.png)

3. 原理图(先运行 consumer 在 node2 创建 fed_exchange)

![image-20230712205717015](./0. RabbitMq基础理论.assets/image-20230712205717015.png)

4. 在 downstream(node2)配置 upstream(node1)

![image-20230712205738497](./0. RabbitMq基础理论.assets/image-20230712205738497.png)

4. 添加 policy

![image-20230712205759964](./0. RabbitMq基础理论.assets/image-20230712205759964.png)

5. 成功的前提

![image-20230712205814908](./0. RabbitMq基础理论.assets/image-20230712205814908.png)
...
![image-20230712023719647](./0. RabbitMq基础理论.assets/image-20230712023719647.png)

2. 添加 upstream(同上)

3. 添加 policy

![image-20230712210716937](./0. RabbitMq基础理论.assets/image-20230712210716937.png)
...
![image-20230712210804239](./0. RabbitMq基础理论.assets/image-20230712210804239.png)

2.原理图(在源头发送的消息直接回进入到目的地队列)

<img src="./0. RabbitMq基础理论.assets/image-20230712210820060.png" alt="image-20230712210820060" style="zoom:50%;" />

3. 添加 shovel 源和目的地 

<img src="./0. RabbitMq基础理论.assets/image-20230712210835347.png" alt="image-20230712210835347" style="zoom:50%;" />
